...
- Quietly adds the applicant, current admin role members, and current logistics role members to the private thread.
...
- Posts the applicant screenshot and verifier name into the verification logs channel.
...
7. In the verification logs channel, make sure Vera can view the channel, send messages, and embed links.
...
VERIFICATION_LOGS_CHANNEL_ID=replace_with_verification_logs_channel_id
```
