...
- Shows staff-only buttons:
  ...
  - **Verify N0VA**
  - **Reject**
- Gives the selected verified role and removes the waiting room role.
...
5. Make sure Vera's highest role is above the waiting room, PVP, and N0VA roles.
...
2. Run `/setup_verification_panel`.
