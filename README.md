...
- After staff choose an age, Vera posts staff-only group buttons:
  ...
  - **n0va**
  - **Nova3**
- Gives the selected NOVA PVP, n0va, or Nova3 role, gives the selected under/over 18 role, and removes the waiting room role.
...
5. Make sure Vera's highest role is above the waiting room, NOVA PVP, n0va, Nova3, under 18, and over 18 roles.
