...
VERA_PURPLE = discord.Color(0x7B2CBF)
...
async def verahelp(interaction: discord.Interaction) -> None:
    embed = discord.Embed(
        title="Vera Help",
        description="Hi, I am Vera your handy verification bot.",
        color=VERA_PURPLE,
    )
    embed.add_field(
        name="/vera",
        value="Posts the NOVA verification panel with the Verify button. Staff with Manage Server can use this.",
        inline=False,
    )
    embed.add_field(
        name="/verahelp",
    ...
    embed.add_field(
        name="Verify button",
        value=(
            "Opens a private verification thread, asks the member for a recent game profile screenshot, "
            "and pings Admin and Logistics."
        ),
        inline=False,
    )
    embed.add_field(
        name="Staff verification buttons",
        value=(
            "Admin or Logistics choose Under 18 or Over 18, then choose PVP, N0VA, or Guest Pass. "
            "Vera assigns the selected roles and removes waiting room."
        ),
        inline=False,
    )
    embed.add_field(
    ...
    embed.add_field(
        name="vera pull up [player name]'s verification details",
        value=(
            "Staff can type this in chat to search swamp logs for a previous verification by server name, "
            "username, global name, or Discord user ID."
        ),
        inline=False,
    )
