...
NOVA_PVP_ROLE_ID = 1474595541022412983
NOVA_ROLE_ID = 1474597083838414939
NOVA3_ROLE_ID = 1496274605164204083
...
GROUP_NOVA_PVP_UNDER_18_BUTTON_ID = "vera:group_nova_pvp_under_18"
GROUP_NOVA_PVP_OVER_18_BUTTON_ID = "vera:group_nova_pvp_over_18"
GROUP_NOVA_UNDER_18_BUTTON_ID = "vera:group_nova_under_18"
GROUP_NOVA_OVER_18_BUTTON_ID = "vera:group_nova_over_18"
GROUP_NOVA3_UNDER_18_BUTTON_ID = "vera:group_nova3_under_18"
GROUP_NOVA3_OVER_18_BUTTON_ID = "vera:group_nova3_over_18"
...
class GroupDecisionView(discord.ui.View):
    ...
    @discord.ui.button(
        label="NOVA PVP",
        style=discord.ButtonStyle.primary,
        custom_id=GROUP_NOVA_PVP_UNDER_18_BUTTON_ID,
    )
    async def nova_pvp(
        self,
        interaction: discord.Interaction,
        ...
        await finish_verification(interaction, NOVA_PVP_ROLE_ID, "NOVA PVP", self.age_role_id, self.age_label)
    ...
    @discord.ui.button(
        ...
        custom_id=GROUP_NOVA3_UNDER_18_BUTTON_ID,
    )
    async def nova3(
        self,
        interaction: discord.Interaction,
        ...
        await finish_verification(
            interaction, NOVA3_ROLE_ID, "Nova3", self.age_role_id, self.age_label
        )
...
async def verahelp(interaction: discord.Interaction) -> None:
    ...
    embed.add_field(
        ...
        value=(
            ...
            "Then I ask whether they should be **NOVA PVP**, **n0va**, or **Nova3**. "
